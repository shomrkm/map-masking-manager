...
export class TaskRepository implements ITaskRepository {
    ...
    const tasks = taskDocs.map(
      (taskDto) =>
        new Task({
          ...
          targets: new Targets(taskDto.target, targetTypes),
  ...
  public async findById(id: string): Promise<Task> {
    ...
    const task = new Task({
      ...
      targets: new Targets(taskDoc.target, targetTypes),
    ...
    const tasks = taskDocs.map(
      (task) =>
        new Task({
          ...
          targets: new Targets(task.target, targetTypes),
  ...
  public async save(task: Task): Promise<Task> {
    ...
    return new Task({
      ...
      targets: new Targets(taskDto.targets, targetTypes),
